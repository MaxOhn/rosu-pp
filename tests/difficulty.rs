...
macro_rules! test_cases {
    ...
    ( @Osu {
        ...
        reading_note_count: $reading_note_count:literal,
        ...
        OsuDifficultyAttributes {
            ...
            reading_note_count: $reading_note_count,
    ...
    test_cases! {
        Osu: OSU {
            NM => {
                ...
                speed: 2.4079921566524338,
                flashlight: 0.0,
                reading: 1.2807842408799812,
                slider_factor: 0.97955486167852612,
                aim_top_weighted_slider_factor: 0.6280004197964858,
                speed_top_weighted_slider_factor: 0.53840750544558069,
                speed_note_count: 796.60849945939026,
                reading_note_count: 97.229859463848399,
                aim_difficult_strain_count: 154.31162398617261,
                speed_difficult_strain_count: 432.92911452386227,
                nested_score_per_object: 26.395781637717121,
...
impl AssertEq for OsuDifficultyAttributes {
    fn assert_eq(&self, expected: &Self) {
        ...
        assert_eq_float(*reading_note_count, expected.reading_note_count);
        assert_eq_float(
            *aim_difficult_strain_count,
