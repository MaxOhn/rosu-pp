...
macro_rules! test_cases {
    ...
    ( @Taiko {
        ...
        rhythm_top_strains: $rhythm_top_strains:literal,
        color_top_strains: $color_top_strains:literal,
        stamina_top_strains: $stamina_top_strains:literal,
        stars: $stars:literal,
        max_combo: $max_combo:literal,
        ...
        TaikoDifficultyAttributes {
            ...
            rhythm_top_strains: $rhythm_top_strains,
            color_top_strains: $color_top_strains,
            stamina_top_strains: $stamina_top_strains,
            stars: $stars,
            max_combo: $max_combo,
    ...
    test_cases! {
        Taiko: TAIKO {
            NM => {
                ...
                rhythm_top_strains: 16.396247965238626,
                color_top_strains: 57.553200524356534,
                stamina_top_strains: 59.38938857603363,
            ...
            HR => {
                ...
                ok_hit_window: 68.0,
                mono_stamina_factor: 2.5849839992846003E-07,
                rhythm_top_strains: 16.341912548059625,
                color_top_strains: 57.553200524356534,
                stamina_top_strains: 59.38938857603363,
            ...
            DT => {
                ...
                rhythm_top_strains: 33.94424268688089,
                color_top_strains: 74.55777319473758,
                stamina_top_strains: 63.349949986391856,
    ...
    test_cases! {
        Taiko: OSU {
            NM => {
                ...
                rhythm_top_strains: 49.29454357234664,
                color_top_strains: 156.1338965777685,
                stamina_top_strains: 189.58797576615237,
            ...
            HR => {
                ...
                ok_hit_window: 50.0,
                mono_stamina_factor: 0.0014311041774359666,
                rhythm_top_strains: 48.953575486971616,
                color_top_strains: 156.1338965777685,
                stamina_top_strains: 189.58797576615237,
            ...
            DT => {
                ...
                rhythm_top_strains: 79.51916183921395,
                color_top_strains: 195.41706714469686,
                stamina_top_strains: 233.31840028238037,
...
impl AssertEq for TaikoDifficultyAttributes {
    fn assert_eq(&self, expected: &Self) {
        ...
        assert_eq_float(*rhythm_top_strains, expected.rhythm_top_strains);
        assert_eq_float(*color_top_strains, expected.color_top_strains);
        assert_eq_float(*stamina_top_strains, expected.stamina_top_strains);
        assert_eq_float(*stars, expected.stars);
        assert_eq!(*max_combo, expected.max_combo);
