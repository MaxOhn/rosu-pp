macro_rules! __define_skill_impl {
    ...
    (
        ...
        __define_skill_impl! {
            ...
            fields {
                ...
                skill_strain_peaks Vec<crate::any::difficulty::skills::variable_length_strain_skill::StrainPeak> = Vec::with_capacity(256), // <-
    ...
    // Extend `StrainDecaySkill`'s fields (adds `skill_current_strain`, then chains to `StrainSkill`)
    (
        @$trait:ident $objects:ty[$object:ty]
        ...
        const _: () = {
            ...
            use crate::{
                ...
                any::difficulty::{
                    ...
                    skills::{
                        skill::Skill,
                        strain_decay_skill::StrainDecaySkill,
                        strain_skill::StrainSkill,
            ...
            __define_skill_impl!( @impl $trait $name $objects[$object] );
        };
    };
    ...
    ( @impl StrainSkill $name:ident $objects:ty[$object:ty] ) => {
        __define_skill_impl!( @impl Skill $name $objects[$object] );
        ...
        impl StrainSkill for $name {
            ...
            fn difficulty_value(current_strain_peaks: Vec<f64>) -> f64 {
                crate::any::difficulty::skills::strain_skill::strain_skill_difficulty_value(
    ...
    // Implement `StrainDecaySkill` trait (adds decay pattern, then chains to `StrainSkill`)
    ( @impl StrainDecaySkill $name:ident $objects:ty[$object:ty] ) => {
        __define_skill_impl!( @impl StrainSkill $name $objects[$object] );
    ...
    ( @impl VariableLengthStrainSkill $name:ident $objects:ty[$object:ty] ) => {
        ...
        impl VariableLengthStrainSkill for $name {
            ...
            fn save_current_peak(&mut self, section_length: f64) {
                let peak = crate::any::difficulty::skills::variable_length_strain_skill::StrainPeak::new(self.skill_current_section_peak, section_length);
            ...
            fn into_current_strain_peaks(self) -> Vec<crate::any::difficulty::skills::variable_length_strain_skill::StrainPeak> {
                self.skill_strain_peaks
            }
    ...
    ( @impl HarmonicSkill $name:ident $objects:ty[$object:ty] ) => {
        ...
        impl HarmonicSkill for $name {
            ...
            fn difficulty_value(transformed_object_difficulties: Vec<f64>) -> (f64, f64) {
                crate::any::difficulty::skills::harmonic_skill::harmonic_skill_difficulty_value(
            ...
            fn count_top_weighted_object_difficulties(
                ...
                crate::any::difficulty::skills::count_top_weighted_object_difficulties(
                    difficulty_value,
                    &self.skill_object_difficulties,
                    object_weight_sum,
                    0.88,
